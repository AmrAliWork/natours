...
exports.protect = catchAsync(async (req, res, next) => {
  ...
  if (!token && req.cookies.jwt && req.cookies.jwt !== 'loggedout') {
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  //2 If token is not expired and there is user, Sent the new password
  if (!user) {
...
exports.updatePassword = catchAsync(async (req, res, next) => {
  ...
  // check if the posted passored is correct (match one saved in record)
